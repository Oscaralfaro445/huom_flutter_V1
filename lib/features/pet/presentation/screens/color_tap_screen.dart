...
import '../../../../game/minigames/color_tap_game.dart';
import '../providers/pet_provider.dart';

class ColorTapScreen extends ConsumerStatefulWidget {
  const ColorTapScreen({super.key});

  @override
  ConsumerState<ColorTapScreen> createState() => _ColorTapScreenState();
}

class _ColorTapScreenState extends ConsumerState<ColorTapScreen> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (_gameOver) _ColorTapGameOver(
            score: _finalScore,
            coins: _coinsEarned,
            onReplay: _startGame,
...
class _ColorTapGameOver extends StatelessWidget {
  final int score;
  final int coins;
  final VoidCallback onReplay;
  final VoidCallback onExit;

  const _ColorTapGameOver({
    required this.score,
    required this.coins,
